...
set(shadercross_dxc OFF)
if((VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_UWP AND
        NOT VCPKG_TARGET_IS_XBOX AND NOT VCPKG_TARGET_ARCHITECTURE STREQUAL "arm") OR
        (VCPKG_TARGET_IS_LINUX AND VCPKG_TARGET_ARCHITECTURE STREQUAL "x64"))
    set(shadercross_dxc ON)
endif()

vcpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        -DSDLSHADERCROSS_DXC=${shadercross_dxc}
